...
\begin{itemize}[leftmargin=*,nosep]
  \item A deeper network needs more data to pay for its extra parameters, so a sweep run on a fifth of the data systematically prefers the small ones --- and never finds out
