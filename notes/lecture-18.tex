...
\begin{failbox}[title={The problem attention creates}]
...
\begin{failbox}[title={That is a difference, not a victory}]
...
\begin{failbox}[title={Reviewer question 2: what was fitted, and on what?}]
