...
"""),
        prompt(
            ...
            check="'Epoch 5, Loss: 2.3026' is five decimal places of nothing, formatted to look like progress. Anchor every loss you print."),
        code('''
...
"""),
        prompt(
            ...
            check="the corrected specification has three additions and each is something the assistant cannot know unless you say it: what a defensible default is, what the number must be compared against, and what evidence to produce when the answer is 'it did not work'."),
        code('''
...
"""),
        prompt(
            ...
            check="photograph this table. The per-layer attenuation is the number the next lecture predicts from first principles, and predicting a number you have already seen is not the same exercise."),
        code('''
print("=" * 62)
