...
\begin{failbox}[title={A pixel is a feature, and that costs something}]
...
\begin{failbox}[title={The pairing is not optional}]
...
\begin{failbox}[title={Neither knob dominates --- on this grid, at this scale}]
...
\begin{failbox}[title={The problem underneath all four}]
