...
\begin{failbox}[title={Failure condition --- what forgetting the cast costs}]
...
\begin{failbox}[title={Failure condition --- accuracy is unbounded above by uselessness}]
...
$6.9733 - 1.0367 = 5.9366$ against a measured difference of $5.9367$.
...
\begin{failbox}[title={Failure condition --- two sentences, both true}]
...
\begin{failbox}[title={Failure condition --- why the crossing needs a support test}]
...
\begin{failbox}[title={Failure condition --- tuning until the test number looks right}]
