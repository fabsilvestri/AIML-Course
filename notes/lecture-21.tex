...
\begin{failbox}[title={Failure condition --- a random split of ratings is not innocent}]
...
\begin{failbox}[title={Failure condition --- one condition, and it is not met}]
...
\begin{failbox}[title={Failure condition --- an update that quietly changes the algorithm}]
