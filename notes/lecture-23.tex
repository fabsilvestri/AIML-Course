...
\begin{failbox}[title={Failure condition --- it does not even typecheck}]
...
\begin{failbox}[title={Failure condition --- why $\tau = 1$ cannot work}]
...
\begin{failbox}[title={Failure condition --- two consequences worth carrying away}]
...
\begin{failbox}[title={Failure condition --- one line worth staring at}]
...
\begin{failbox}[title={Failure condition --- the tie bug, which reports 100\%}]
