...
Five questions at the end of every deck, 1 to 24. Lecture N's solutions are on
lecture N+1's deck; lecture 24 carries 23's solutions, its own five, and its own
solutions. Generated by `tools/make_exercises.py` from one table, injected
