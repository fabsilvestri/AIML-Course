...
\begin{failbox}[title={Failure condition --- one trap in that code, worth ten minutes of your life}]
\begin{verbatim}
...
\begin{failbox}[title={Failure condition --- an ensemble has no per-prediction justification}]
...
\begin{failbox}[title={Failure condition --- two structural biases, not an accident}]
...
\begin{failbox}[title={Failure condition --- the intuition that does not carry across}]
