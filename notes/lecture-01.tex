...
\begin{failbox}[title={Failure condition --- the assumption that would have sunk this project}]
...
\begin{failbox}[title={Failure condition --- why a capped label is more serious than a capped feature}]
...
\begin{failbox}[title={Failure condition --- the shape of this failure}]
...
\begin{failbox}[title={Failure condition --- two things $r$ does not tell you}]
