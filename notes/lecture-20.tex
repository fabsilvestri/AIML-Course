...
\begin{failbox}[title={Failure condition --- masking the padding is not optional}]
...
\begin{failbox}[title={Failure condition --- ``In-batch negatives are free''}]
...
\begin{failbox}[title={Failure condition --- the pooling problem, now inside training}]
...
On this corpus, of 1.55 million claim--abstract pairs only 339 are judged
...
\begin{failbox}[title={Failure condition --- index recall and model quality, conflated}]
