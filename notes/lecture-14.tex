...
\begin{failbox}[title={Failure condition --- a box is four numbers, and which four is not agreed}]
...
\begin{failbox}[title={Failure condition --- there is already a cut-off, and it is not yours}]
