...
\begin{failbox}[title={But Lecture 11 said what happens to a gradient descending 56 layers}]
...
\begin{failbox}[title={And the assumption, stated rather than left implied}]
...
\begin{failbox}[title={Bidirectional layers, and the one question}]
...
\begin{failbox}[title={And the shuffled split cannot see it at all}]
