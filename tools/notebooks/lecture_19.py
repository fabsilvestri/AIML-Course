...
**These notes are the primary source for this lecture.** Lectures 19–22 sit outside the textbook, so the extended notes — [lecture-19.pdf](https://fabsilvestri.github.io/AIML-Course/notes/lecture-19.pdf) — are what you are examined from, and this notebook is where their figures come from.
