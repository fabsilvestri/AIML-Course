...
\begin{failbox}[title={A failure condition, stated in advance}]
...
\begin{failbox}[title={Centre first, and say why}]
...
\begin{failbox}[title={The decision rule, and why it is still procedural}]
...
\begin{failbox}[title={A bias that needs no labels to exist}]
...
\begin{failbox}[title={Careful: the silhouette went up}]
