...
\begin{failbox}[title={Failure condition --- Boolean retrieval, over all 300 test claims}]
\begin{center}
\small
\begin{tabular}{lr}
...
\begin{failbox}[title={Failure condition --- where marks are lost}]
...
\begin{failbox}[title={Failure condition --- what pooling misses}]
\begin{itemize}[leftmargin=*,nosep]
