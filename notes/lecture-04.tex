...
\begin{failbox}[title={Failure condition --- divergence is silent until it is loud}]
...
\begin{failbox}[title={Failure condition --- unbiased is not the same as right}]
...
\begin{failbox}[title={Failure condition --- accuracy is not proper}]
...
\begin{failbox}[title={Failure condition --- what a rank-deficient design does to the fit}]
...
\begin{failbox}[title={Failure condition --- under separation the minimiser does not exist}]
...
\begin{failbox}[title={Failure condition --- a bare label hides a decision nobody made}]
