...
\begin{failbox}[title={Failure condition --- what it does to training}]
...
\begin{failbox}[title={Failure condition --- ``Running it twice'' needs one caveat}]
...
\begin{failbox}[title={Failure condition --- the last batch is short}]
