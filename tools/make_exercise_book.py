...
\textbf{They are revision, not the oral.} If you sit the optional oral, its
three questions may come from any topic the course covered --- these 120 are
not a bank it draws from, and working through them is preparation for the
written paper rather than a list to learn for the oral.
