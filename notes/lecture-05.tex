...
\begin{failbox}[title={An honest caveat before we measure anything}]
...
\begin{failbox}[title={A penalty requires scaling --- not as a nicety}]
...
\begin{failbox}[title={A hyperparameter chosen on the rows you then report}]
