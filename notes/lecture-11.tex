...
\begin{failbox}[title={Failure condition --- the probe measured the wrong thing}]
...
\begin{failbox}[title={Failure condition --- two replies that do not work}]
...
\begin{failbox}[title={Failure condition --- the bill batch normalisation carries}]
