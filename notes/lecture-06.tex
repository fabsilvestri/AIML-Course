...
\begin{failbox}[title={Say what you did, and why}]
...
\begin{failbox}[title={The one hyperparameter we may not tune}]
...
\begin{failbox}[title={Read the leaf carefully}]
...
\begin{failbox}[title={Why the tree cannot see Aspen}]
